...
save_path = '/ccn2/u/haw027/b3d_ipe/test/'
...
for hdf5_file in onlyhdf5:
    trial_name = '_'.join(hdf5_file.split('/')[-1:])[:-5]
    ...
    with h5py.File(hdf5_file_path, "r") as f:
        ...
        locations = np.array(f['frames']['0000']['objects']['positions_cam0'])
        rotations = np.array(f['frames']['0000']['objects']['rotations_cam0'])
...
with open(join(save_path, f'annotated_ann_{scenario}.json'), 'w') as f:
    json.dump(file, f)